    ...
    <div>
      ...
      <Row>
          ...
          <Card className="mb-3">
            <Card.Body>
              ...
              {order.isDelivered ? (
                ...
                <MessageBox variant="danger">Pedido sin despachar</MessageBox>
              )}
            </Card.Body>
          </Card>
          <Card className="mb-3">
            <Card.Body>
              <Card.Title>¿Cómo querés pagar? </Card.Title>
              <Card.Text>
              ...
              {order.isPaid ? (
                ...
                <MessageBox variant="danger">No abonado</MessageBox>
              )}
            </Card.Body>
          </Card>
        ...
        <Col md={4}>
          <Card className="mb-3">
            <Card.Body>
              <Card.Title>Detalle Pedido</Card.Title>
              <ListGroup variant="flush">
                <ListGroup.Item>
                  <Row>
                    <Col>Articulos</Col>
